...
const featuresData = [
  ...
  },
  {
    ...
    description: "Customize voting periods, quorum percentages, and create proposals using Aptops's powerful consensus mechanism.",
    icon: Vote,
    color: "bg-gradient-to-br from-blue-500 to-daoship-mint",
  },
  {
    title: "Secure on Aptops",
    description: "Built on Aptops's fast, secure, and carbon-negative blockchain technology — perfect for sustainable projects.",
    icon: Shield,
    color: "bg-gradient-to-br from-daoship-mint to-green-500",
  },
  {
    title: "Token Management",
    description: "Create and distribute governance tokens seamlessly with built-in Aptops Standard Asset (ASA) integration.",
    icon: Wallet,
    color: "bg-gradient-to-br from-yellow-500 to-daoship-yellow",
  },
  {
    title: "Fast Transactions",
    description: "Experience almost instant finality and microtransactions with Aptops's cutting-edge Pure Proof-of-Stake protocol.",
    icon: Zap,
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-daoship-text-gray/80">
            Leverage the power of Aptops with our comprehensive suite of tools designed specifically for builders and creators.
          </p>
        </div>

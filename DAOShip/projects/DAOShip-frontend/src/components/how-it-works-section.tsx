...
const steps = [
  {
    ...
    description: "Link your Aptops wallet securely to get started with DAOShip. We support Pera Wallet, MyAlgo and more.",
    delay: 0,
  },
  {
    number: "02",
    title: "Create Your DAO",
    description: "Set up governance parameters, issue your token on Aptops, and customize voting rules to fit your community's needs.",
    delay: 200,
  },
  {
    number: "03",

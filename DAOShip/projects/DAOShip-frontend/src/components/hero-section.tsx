        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="text-left">
            ...
            <p className="text-xl md:text-2xl mb-8 text-daoship-text-gray max-w-2xl opacity-80">
              Create, deploy and manage DAOs on Aptops in minutes. Join the decentralized governance revolution without writing a single line of code.
            </p>
          ...
          <div className="relative">
            ...
            <GlassmorphicCard className="relative z-10 max-w-md mx-auto p-8" glowEffect>
              ...
              <p className="text-daoship-text-gray mb-8">
                Leverage the power of Aptops's fast, secure, and sustainable blockchain with our intuitive tools.
              </p>
